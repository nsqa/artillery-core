...
HttpEngine.prototype.createScenario = function(scenarioSpec, ee) {
  ...
  if (scenarioSpec.afterResponse) {
    if (!_.isArray(scenarioSpec.afterResponse)) {
